...
public class xinlvqushi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xinlvqushi);
        Toolbar toolbar = findViewById(R.id.toolbar_in_xinlv);
